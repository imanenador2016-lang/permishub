 ...
 */
// PRIX TEMPORAIRE (50 centimes, minimum absolu accepté par Stripe pour l'EUR
// — 25 centimes a été refusé avec "amount_too_small") pour valider le tout
// premier vrai paiement live + webhook — voir conversation du 2026-09-03. À
// remettre à 999 juste après ce test, ne JAMAIS laisser ce prix en prod
// au-delà du test.
